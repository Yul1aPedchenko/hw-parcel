...
})({"jFwIB":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "25d44e172bc73d7a";
"use strict";
...
},{}],"h3sXw":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "renderStudents", ()=>renderStudents);
parcelHelpers.export(exports, "updateStudentList", ()=>updateStudentList);
...
var _changeJs = require("./change.js");
...
function renderStudents(students) {
    return students.map((student)=>`<div class="student" id="${student.id}">
      <div class="student-prewrap">
        ...
        <ul class="student-courses">
          ${student.courses.map((course)=>`<li class="student-course">${course}</li>`).join("")}
        </ul>
        </div>
...
function updateStudentList(filteredStudents = (0, _studentsJsonDefault.default)) {
    document.querySelector(".students-list").innerHTML = renderStudents(filteredStudents);
    _deleteJs.addDeleteEventListeners();
    _changeJs.addChangeEventListeners();
}
document.querySelector(".students-list").innerHTML = renderStudents((0, _studentsJsonDefault.default));
_changeJs.addChangeEventListeners();
_deleteJs.addDeleteEventListeners();
...
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "createFaculties", ()=>createFaculties);
...
document.querySelector("#faculties").innerHTML = createFaculties((0, _uniDataJsonDefault.default));
function createCourses(allData, facultyId, selectedCourses = []) {
    const currentData = allData.find((data)=>data.id === parseInt(facultyId));
    if (currentData) return currentData.courses.map((course)=>{
...
const firstFacultyId = (0, _uniDataJsonDefault.default)[0].id;
document.querySelector("#faculties").value = firstFacultyId;
document.querySelector("#courseList").innerHTML = createCourses((0, _uniDataJsonDefault.default), firstFacultyId);
...
},{}],"b2p6p":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "addChangeEventListeners", ()=>addChangeEventListeners);
var _studentsJson = require("../students.json");
var _studentsJsonDefault = parcelHelpers.interopDefault(_studentsJson);
var _uniDataJson = require("../uni_data.json");
var _uniDataJsonDefault = parcelHelpers.interopDefault(_uniDataJson);
...
const coursesEl = Array.from(document.querySelectorAll("#changedCourseList input:checked")).map((checkbox)=>checkbox.value);
function fullModal(takeStudentId) {
    const student = (0, _studentsJsonDefault.default).find((student)=>student.id == takeStudentId);
    if (!student) return;
    const facultyId = (0, _uniDataJsonDefault.default).find((data)=>data.faculty == student.faculty)?.id;
...
function changeStudent(studentId) {
    const student = (0, _studentsJsonDefault.default).find((student)=>student.id == studentId);
    if (!student) return;
    ...
    const selectedFaculty = (0, _uniDataJsonDefault.default).find((data)=>data.id == parseInt(facultySelect.value));
    if (selectedFaculty) student.faculty = selectedFaculty.faculty;
    const selectedCourses = Array.from(document.querySelectorAll("#changedCourseList input:checked")).map((checkbox)=>checkbox.value);
...
function createInfoForChangedForm(curStudentId) {
    ...
    const changedFirstFacultyId = (0, _uniDataJsonDefault.default).find((data)=>data.faculty == curStudent.faculty);
    changedFacultiesEl.innerHTML = _loadJs.createFaculties((0, _uniDataJsonDefault.default));
    changedFacultiesEl.value = changedFirstFacultyId.id;
    const changedCourseListEl = document.querySelector("#changedCourseList");
    changedCourseListEl.innerHTML = _loadJs.createCourses((0, _uniDataJsonDefault.default), changedFirstFacultyId.id, curStudent.courses);
    changedFacultiesEl.addEventListener("change", (event)=>{
        const facultyId = event.target.value;
        changedCourseListEl.innerHTML = _loadJs.createCourses((0, _uniDataJsonDefault.default), facultyId, curStudent.courses);
    });
}

},{"../students.json":"6W3sm","../uni_data.json":"4G3hd","./index.js":"h3sXw","./load.js":"kMT9h","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jevGD":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
var _studentsJson = require("../students.json");
var _studentsJsonDefault = parcelHelpers.interopDefault(_studentsJson);
var _indexJs = require("./index.js");
const filtereData = (query)=>{
    const filteredUsers = (0, _studentsJsonDefault.default).filter((student)=>student.lastName.toLowerCase().includes(query.toLowerCase()));
    _indexJs.updateStudentList(filteredUsers);
};
document.getElementById("search").addEventListener("input", (event)=>{
    filtereData(event.target.value);
});
const filtredDataByBtn = (course)=>{
    const filteredUsersA = (0, _studentsJsonDefault.default).filter((student)=>{
        return student.courseNumber == course;
    });
    _indexJs.updateStudentList(filteredUsersA);
};
...
document.querySelector(".reset-btn").addEventListener("click", ()=>{
    _indexJs.updateStudentList((0, _studentsJsonDefault.default));
});

},{"../students.json":"6W3sm","./index.js":"h3sXw","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"2LogV":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
var _studentsJson = require("../students.json");
var _studentsJsonDefault = parcelHelpers.interopDefault(_studentsJson);
var _uniDataJson = require("../uni_data.json");
...
document.getElementById("addStudent").addEventListener("click", (event)=>{
    ...
    if (firstName && lastName && age && courseNumber && selectedCourses.length > 0) {
        ...
        document.getElementById("faculties").value = (0, _uniDataJsonDefault.default)[0].id;
        document.querySelector("#courseList").innerHTML = _loadJs.createCourses((0, _uniDataJsonDefault.default), (0, _uniDataJsonDefault.default)[0].id);
    } else alert("Please fill out all fields and select at least one course.");
});

},{"../students.json":"6W3sm","../uni_data.json":"4G3hd","./index.js":"h3sXw","./load.js":"kMT9h","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"8V7AH":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "addDeleteEventListeners", ()=>addDeleteEventListeners);
var _studentsJson = require("../students.json");
var _studentsJsonDefault = parcelHelpers.interopDefault(_studentsJson);
var _uniDataJson = require("../uni_data.json");
var _uniDataJsonDefault = parcelHelpers.interopDefault(_uniDataJson);
...
function deleteStudent(studentId) {
    const studentIndex = (0, _studentsJsonDefault.default).findIndex((student)=>student.id === studentId);
    if (studentIndex !== -1) {
        (0, _studentsJsonDefault.default).splice(studentIndex, 1);
        _indexJs.updateStudentList();
    }
}
...
},{"../students.json":"6W3sm","../uni_data.json":"4G3hd","./index.js":"h3sXw","./load.js":"kMT9h","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["jFwIB","h3sXw"], "h3sXw", "parcelRequire94c2")

//# sourceMappingURL=index.2bc73d7a.js.map
